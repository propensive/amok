...
# Contributing to Amok

Firstly, thank you for taking an interesting in contributing! Amok is an
...
Amok is one of a large number of
...
issue](https://github.com/propensive/amok/issues) or contact the project
...
have commit rights to the `propensive/amok` repository, push to a branch named
...
in extreme cases. Amok does not use automatic code-formatting because it
...
Amok&rsquo;s users. Individualism is valued, and nobody should feel
